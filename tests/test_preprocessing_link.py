...
def test_directed_convex_link_entry():
    ...
    link = Link(
        label="test_link",
        inputs={
            input_bus: Flow(variable_costs=0, emission_factor=0),
        ...
        conversion_factors={(input_bus, output_bus): 1, (output_bus, input_bus): 1},
    )
...
def test_undirected_non_convex_link_entry():
    ...
    link = Link(
        ...
        inputs={
            input_bus: Flow(variable_costs=0, emission_factor=0),
            output_bus: Flow(variable_costs=0, emission_factor=0),
        },
        outputs={
            input_bus: Flow(
                variable_costs=10,
...
def test_get_flow(test_link_nodes_data, test_undirected_non_convex_link_entry):
    """
...
def test_links(
    ...
    comparison_of_flow_attributes(
        nodes=[nodes[0]], test_link_entry=test_directed_convex_link_entry
    )

    comparison_of_flow_attributes(
        nodes=[nodes[1]], test_link_entry=test_undirected_non_convex_link_entry
    )
