...
.. note:: 
	...
	If your device does not have homebrew installed, install it by typing ``/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"`` in your terminal. For macOS
...
.. figure:: images/manual/Installation/sesmg_installation_mac_1.png
   ...
   .. note:: 
	...
	You have to confirm the file run in your mac's security settings to be able to run it.
