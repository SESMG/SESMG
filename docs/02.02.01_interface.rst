...
The basis for any application is the so-called *model_definition.xlsx*, wich can be created either manually or automatically.

.. figure:: ../docs/images/manual/GUI/main_page.png
   :width: 100 %
   :alt: GUI
   :align: center
