...
The model definition is created automatically and can be viewed on the right side. If you agree with the model definition, it can be downloaded. The model definition serves as a basis for the optimization process and can be used on the Main Application.
