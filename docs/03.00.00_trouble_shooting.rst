...
Error M-029: KeyError: 'sector'
-------------------------------------------------
**Error Message:** ::

   raise KeyError(key) from err

**Possible Error Cause:** In the model definiton the 'sector'-column in the sheed 'sinks' has to be filled out.

**Debugging:** Make sure, that you have filled out the 'sector'-column in the sheed 'sinks'. Use the actual version of the model definition spreadsheed. 
