...
places by dafault in the /users/documents/SESMG/result direcotory. The directory
is created by the SESMG application. You can change the direcotry when you are
