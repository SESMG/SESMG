...
.. csv-table:: Input for the upscaling sheet. Category 3: Central investment data.
   ...
   ngh_chp,,0,naturalgas_hydrogen_chp,,,,heat_input,,,,, 
...
.. csv-table:: All possible central technologies.
   ...
   naturalgas_chp, natural gas combined heat and power (CHP)
   naturalgas_hydrogen_chp, natural gas and hydrogen chp (two inputs)
