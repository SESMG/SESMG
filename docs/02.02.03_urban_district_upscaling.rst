...
.. csv-table:: Input for the upscaling sheet. Category 3: Central investment data.
   :header:  label,comment,active,technology,latitude,longitude,area,dh_connection,azimuth,surface tilt,flow temperature, length of the geoth. probe

   ,,,,° WGS 84,° WGS 84,sqm,,°,°,°C,m
   ...
   gchp,free area needed,1,gchp_transformer,,,2500,heat_input,,,,100
