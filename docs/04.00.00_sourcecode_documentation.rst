...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. .. automodule:: program_files.GUI_st.1_Main_Application
    :members:
    :undoc-members:
    :show-inheritance:
...
Preprocessing/data_preparation/heuristic_sampling
'''''''''''''''''''''''''''''''''''''''''''''''''''''''
.. automodule:: program_files.preprocessing.data_preparation_algorithms.heuristic_sampling
   :members:
   :undoc-members:
   :show-inheritance:
