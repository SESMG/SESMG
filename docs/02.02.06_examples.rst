...
model definition with solutions `here <https://github.com/SESMG/SESMG-Examples/blob/main/SESMG-v1.0.x-Examples/Task_1_solution_model_definition.xlsx>`_. This example is intended as an introduction and has an exercise
character.
...
model definition with solutions `here <https://github.com/SESMG/SESMG-Examples/blob/main/SESMG-v1.0.x-Examples/Task_2_solution_model_definition.xlsx>`_. This example is intended as an introduction and has an exercise
character.
