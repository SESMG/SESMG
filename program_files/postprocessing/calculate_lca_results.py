...
def consider_var_cost_factor(components_list, variable_cost_factor) -> pd.DataFrame:
    ...
    # TODO -> mal prüfen, ob Gregor das vielleicht schon geändert/behoben hat
...
def add_lca_uuid(filtered_components) -> dict:
    ...
    for index, row in filtered_components.iterrows():
        ...
        #  muss auch geändert werden, weil es so mit der neuen Version jetzt nicht mehr funktioniert

        # todo übergangsweise mal nur mit system prozessen arbeiten
...
# TODO das passiert natürlich nur bei nem Pareto Lauf!
