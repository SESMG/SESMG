...
def run_pareto(limits, files, gui_variables, timeseries_prep_param, directory,result_folders, pre_modeling, pre_model_timeseries_prep=[],
               investment_boundaries=False,investment_boundary_factor=1,pre_model_path=''):
