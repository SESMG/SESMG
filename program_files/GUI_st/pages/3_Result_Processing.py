...
def short_result_summary_time(result_path_summary) -> None:
    ...
    time3.metric(label="Temporal Resolution", value=str(df_summary["Resolution"][0]))
...
def short_result_summary_system(result_path_summary) -> None:
    ...
    cost1.metric(
        label=summary_headers[3],
        value="{:,.2f}".format(float(round(df_summary[summary_headers[3]], 1))),
    )
    cost2.metric(
        label=summary_headers[4],
        value="{:,.2f}".format(float(round(df_summary[summary_headers[4]], 1))),
    )
    cost3.metric(
        label=summary_headers[5],
        value="{:,.2f}".format(float(round(df_summary[summary_headers[5]], 1))),
    )
    cost4.metric(
        label=summary_headers[6],
        value="{:,.2f}".format(float(round(df_summary[summary_headers[6]], 1))),
    )
    ...
    ener1.metric(
        label=summary_headers[7],
        value="{:,.2f}".format(float(round(df_summary[summary_headers[7]], 1))),
    )
    ener2.metric(
        label=summary_headers[8],
        value="{:,.2f}".format(float(round(df_summary[summary_headers[8]], 1))),
    )
...
def show_energy_amounts(
    result_path_heat_amounts: str, result_path_elec_amounts: str
) -> None:
    """
