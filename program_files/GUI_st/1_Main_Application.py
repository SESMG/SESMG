...
def main_start_page() -> None:
    ...
    reduced_readme = read_markdown_document("README.md", f'{"docs/images/readme/*"}')
...
def main_input_sidebar() -> st.runtime.uploaded_file_manager.UploadedFile:
    ...
    with st.sidebar.form("Input Parameters"):
        ...
        with tab_bar[0]:
            ...
            # Dict of choosable timeseries periods matching the streamlit \
            # input index for selectbox's preselections
            input_timeseries_season_dict = {"None": 0, 4: 1, 12: 2}
            ...
            with st.expander(label="Timeseries Simplification"):
                ...
                GUI_main_dict["input_timeseries_algorithm"] = st.selectbox(
                    label="Algorithm",
                ...
                GUI_main_dict["input_timeseries_cluster_index"] = st.selectbox(
                    label="Index",
                ...
                GUI_main_dict["input_timeseries_criterion"] = st.selectbox(
                ...
                GUI_main_dict["input_timeseries_period"] = st.selectbox(
                    label="Period",
                ...
                GUI_main_dict["input_timeseries_season"] = st.selectbox(
                    label="Season",
            ...
            create_simplification_index(
                input_list=simpification_index_list, input_output_dict=GUI_main_dict
            )
            ...
            with st.expander("Pre-Modeling Settings"):
                ...
                GUI_main_dict["input_activate_premodeling"] = st.checkbox(
                ...
                GUI_main_dict["input_premodeling_invest_boundaries"] = st.checkbox(
                ...
                # capacity
                GUI_main_dict["input_premodeling_tightening_factor"] = st.slider(
                ...
                GUI_main_dict["input_premodeling_timeseries_algorithm"] = st.selectbox(
                ...
                GUI_main_dict["input_premodeling_timeseries_criterion"] = st.selectbox(
                ...
                GUI_main_dict["input_premodeling_timeseries_period"] = st.selectbox(
                ...
                GUI_main_dict["input_premodeling_timeseries_season"] = st.selectbox(
            ...
            with st.expander("Advanced District Heating Precalculation"):
                ...
                GUI_main_dict["input_cluster_dh"] = st.checkbox(
                ...
                GUI_main_dict["input_activate_dh_precalc"] = st.checkbox(
                    ...
                    value=settings_cache_dict_reload["input_activate_dh_precalc"],
            ...
            GUI_main_dict["input_criterion_switch"] = st.checkbox(
        ...
        with tab_bar[1]:
            ...
            input_solver_dict = {"cbc": 0, "gurobi": 1}
            ...
            # input index
            GUI_main_dict["input_solver_index"] = input_solver_dict[
                GUI_main_dict["input_solver"]
            ]
        ...
        with tab_bar[2]:
            ...
            GUI_main_dict["input_xlsx_results"] = st.checkbox(
...
def create_result_paths() -> None:
    ...
    st.session_state["state_premodeling_res_path"] = GUI_main_dict[
        "premodeling_res_path"
    ]
    ...
    if not model_definition_input_file:
        ...
        # Starting a pareto modeul rum
            ...
            with st.spinner("Modeling in Progress..."):
                ...
                GUI_main_dict["res_path"] = run_pareto(
