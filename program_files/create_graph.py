            ...
            if b["active"]:
                ...
                if i != "buses":
                    ...
                    if i == "sources":
                        ...
                        if (
                            b["technology"] == "solar_thermal_flat_plate"
                            or b["technology"] == "CSP"
                        ):
                ...
                if (
                    ...
                    or i == "storages"
                    or i == "links"
                    or (i == "buses" and b["excess"] and not b["shortage"])
                ):
                    dot.edge(b[bus[i][0]], label)
                if (
                    (
                        i == "sources"
                        and (b["technology"] not in ["solar_thermal_flat_plate", "CSP"])
                    )
                    or i == "storages"
                ...
                if i == "links":
                    ...
                    if b["transformer type"] == "compression_heat_transformer":
                        ...
                        dot.node(cmpr_abs_bus, shape="ellipse", fontsize="10")
