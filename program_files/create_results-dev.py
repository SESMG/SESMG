    ...
    def __init__(self, nodes_data: dict, optimization_model: solph.Model,
        ...
        """
            ...
            The algorithm uses the following steps:
                ...
                1. logging the category for example "sinks"
            ...
            for j, comp in components_dict[i].iterrows():
                if comp['active']:
                    ...
                    if i != 'buses_s' and i != 'buses_e' and i != "sinks":
                        ...
                        # TODO decide about the condition if an
                        #  investment has to be
                        # TODO made for example existing capacity > 0
                    ...
                    # storages
                        ...
                        self.df_result_table[comp['label'] + '_output'] = \
                            self.comp_output1
                        capacity = round(self.comp_capacity, 2)
                    ...
                    # links
                        ...
                        if comp['(un)directed'] == 'undirected':
                            ...
                            # TODO check capacity
                            capacity = round(max(self.comp_input1.max(),
                                                 self.comp_input2.max()), 2)
                        else:
                            # TODO check capacity
                            capacity = round(self.comp_input1.max(), 2)
                    else:
