...
def urban_district_upscaling_tool(pre_scenario: str, standard_parameters: str, output_scenario: str, plain_sheet: str):
    """
    ...
    plain_scenario_path = plain_sheet
    xls = pd.ExcelFile(plain_sheet)
    global standard_param
    standard_param = pd.ExcelFile(standard_parameters)
...
if __name__ == '__main__':
    urban_district_upscaling_tool(pre_scenario=os.path.dirname(__file__) + r"\pre_scenario.xlsx",
                                  standard_parameters=os.path.dirname(__file__) + r"\standard_parameters.xlsx",
