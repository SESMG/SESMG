...
def adaption_energy_system_parameter(
...
def data_set_slicing(
    n_days: int, data_set: pandas.DataFrame, period: str
) -> pandas.DataFrame:
    """
...
def timeseries_slicing(n_days: int, nodes_data: dict, period: str) -> None:
    ...
    adaption_energy_system_parameter(
