...
import sys
from program_files.preprocessing import create_energy_system, data_preparation
...
def sesmg_main(
    ...
    nodes_data = create_energy_system.import_model_definition(filepath=scenario_file)
